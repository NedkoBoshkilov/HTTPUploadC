 ...
 */
int build_request(const struct http_request *_request, char *_dest, uint32_t *_request_size);
 ...
 */
int decode_response(const char *_response, struct http_response *_dest, uint32_t *_headers_length);
 ...
 */
int build_upload_payload_header(const char *_filename, const char *_form_name, const char *_boundary, char *_header, uint32_t *_header_size);
 ...
 */
int build_upload_payload_trailer(const char *_boundary, char *_trailer, uint32_t *_trailer_size);
